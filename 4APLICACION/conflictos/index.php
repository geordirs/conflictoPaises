  ...
  <body id="page-top">
    ...
    <header class="masthead">
      <div class="container d-flex h-100 align-items-center">
        <div class="mx-auto text-center">
          <h1 class="mx-auto my-0 text-uppercase">Terrorismo en Siria</h1>
          <h2 class="text-white-50 mx-auto mt-2 mb-5">Conflicto de poderes</h2>
          <a href="#about" class="btn btn-primary js-scroll-trigger">Continuar</a>
        </div>
      </div>
    </header>
    ...
    <section id="about" class="about-section text-center">
      <div class="container">
        ...
        <img src="img/conflictos/dedo.png" class="img-fluid" alt="">
      </div>
    </section>
